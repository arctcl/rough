...
описывается в одном `tiles.json`. Подробный синтаксис — [guide, раздел 2](guide.md)
и [reference, раздел 2](reference.md); здесь — короткий пример:
...
сводится к кнопкам, полям, формам и выводу. Полный список тегов —
[reference, раздел 1](reference.md); как всё это собирается — [guide](guide.md):
