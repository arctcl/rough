...
| [guide](guide.md) | Tutorial: HTML с нуля, от простого к сложному, живые примеры (начни здесь) |
| [reference](reference.md) | Reference: справочные таблицы — теги, tiles.json, квик-параметры, диапазоны, переменные, плагины |
