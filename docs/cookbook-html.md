...
Клик — меню по центру экрана, стрелки + Enter выбирают, Esc — закрыть.
Выбор дописывается к вызову через `:`.
...
сдвигаются вместе с контентом, так что всё остаётся кликабельным.
